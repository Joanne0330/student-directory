# We are de-facto using CSV format to store data. However, Ruby
# includes a library to work with the CSV files that we could
# use instead of working directly with the files. Refactor the
