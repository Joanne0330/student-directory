# Right now, when the user choses an option from our menu, there's no
# way of them knowing if the action was successful. Can you fix this
# and implement feedback messages for the user?
