...
# it should be "Now we have 1 student". How can you fix
# it so that it used singular form when appropriate and
# plural form otherwise?
def input_students
...
def print_footer(names)
  if names.count < 2
    puts "Overall, we have #{names.count} great students".chomp("s")
  else
